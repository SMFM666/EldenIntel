...
#pragma pack(push, 1)
	...
	struct ChrIns {
		char pad1[0xB4];
		int32_t omissionMode;				// 0xB4, engine-selected update cadence
		int32_t omissionModeOverride;		// 0xB8, frames-per-update override
		int32_t omissionModeSecondary;		// 0xBC
		char pad2[0xD0];
...
#pragma pack(pop)
	...
	ASSERT_OFFSET(ChrIns, omissionMode, 0xB4);
	ASSERT_OFFSET(ChrIns, omissionModeOverride, 0xB8);
